...
module Discordrb::Commands
  ...
  module CommandContainer
    ...
    # @option attributes [Array<Role>, Array<String, Integer>] :required_roles Roles that user must have to use this command
    #   (user must have all of them).
    # @option attributes [Array<Role>, Array<String, Integer>] :allowed_roles Roles that user should have to use this command
